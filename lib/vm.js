...
const TEMPLATE_IMAGE_ID = 'ami-e9ce8580';
...
exports.createAMI = function(name, cb) {
  exports.find(name, function(err, deets) {
    ...
    aws.client.CreateImage({
      ...
      if (err) return extractError(err);
